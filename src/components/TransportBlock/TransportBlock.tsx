...
export const TransportBlock: React.FC = () => {
        ...
        <div className={styles.transportCard}>
          <div className={styles.transportContent}>
            ...
            <p className={styles.subtitle}>
              Организуем неэкстренную перевозку пациентов
            </p>
            
            <div className={styles.transportFeatures}>
              <div className={styles.featureItem}>
                <div className={styles.iconWrapper}>
              <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{fontSize: "inherit", width: "30px", height: "30px"}} className={styles.icon}>
  ...
  <circle cx="7" cy="18" r="2"/>
                ...
                <div className={styles.featureContent}>
                  ...
                  <span className={styles.featureValue}>Авто с оборудованием для перевозки лежачих пациентов</span>
                </div>
              </div>
