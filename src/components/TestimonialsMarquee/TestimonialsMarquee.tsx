...
export const TestimonialsMarquee: React.FC<TestimonialsMarqueeProps> = ({ className }) => {
    ...
    const testimonials = [
        {
            text: "Спасибо экипажу! Быстро приехали, аккуратно спустили маму с 5 этажа, довезли до больницы. Всё на высшем уровне.",
            author: "Анна К."
        },
        {
            text: "Заказывали межгород. В салоне чисто, удобно, сделали остановки по просьбе. Рекомендую.",
            author: "Максим П."
        },
        {
